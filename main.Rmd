...
```{r}
## Evaluate Model Results
ann_wq_test_predict3 <- predict(ann_wq_model3, wq_test, type = 'Potabality')
...
combined_df <- data.frame(lg_predict, knn_pred, ann_wq_test_predict2, svm_model_pred, dt_predict, rf_predict, wq_test_labels)
```
